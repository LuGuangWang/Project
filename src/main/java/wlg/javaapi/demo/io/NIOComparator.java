...
/**
 *  所示代码对传统 I/O、基于 Byte 的 NIO、基于内存映射的 NIO 三种方式进行了性能上的对比，
...
public class NIOComparator {
	public void IOMethod(String TPATH) {
		...
		System.out.println("IOMethod data write:"+(end - start));
		...
		System.out.println("IOMethod data read:"+(end - start));
	}
	...
	public void ByteMethod(String TPATH) {
		...
		long end = System.currentTimeMillis();
		System.out.println("NIO data write:"+(end - start));
		...
		System.out.println("NIO data read:"+(end - start));
	}
